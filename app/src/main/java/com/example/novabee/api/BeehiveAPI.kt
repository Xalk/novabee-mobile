...
interface BeehiveAPI {
    ...
    suspend fun createBeehive(@Path("apiaryId") apiaryId: String, @Body beehiveRequest: BeehiveRequest): Response<BeehiveResponse>
    ...
    suspend fun getBeehive(@Path("apiaryId") apiaryId: String, @Path("beehiveId") beehiveId: String): Response<BeehiveResponse>
